...
class World:
    ...
    def get_dynamic_objects(self):
        ...
        for key in sorted(self.objects.keys()):
            if key != "Counter" and key != "Floor" and "Supply" not in key and key != "Delivery" and key != "Cutboard" and key != "Stove" and key !='Dishwasher' and key !='RubbishBin':
    ...
    def get_object_at(self, location, desired_obj, find_held_objects):
        ...
        if len(objs)==0:
            print([(o.name,o.location) for o in all_objs], desired_obj.name, location, find_held_objects)
